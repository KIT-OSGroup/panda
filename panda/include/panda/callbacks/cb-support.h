...
int panda_callbacks_after_insn_exec(CPUState *env, target_ptr_t pc, target_ptr_t previous_pc);
...
bool panda_callbacks_after_insn_translate(CPUState *env, target_ptr_t pc, target_ptr_t previous_pc);
